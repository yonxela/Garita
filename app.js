document.addEventListener('DOMContentLoaded', () => {
    ...
    form.addEventListener('submit', (e) => {
        ...
        // Validate basic inputs (HTML5 validation mostly covers this, but just in case)
    ...
    btnNewRegistration.addEventListener('click', () => {
        ...
        setTimeout(() => {
            ...
            // Focus on visitor name since neighbor name is likely kept
            visitorInput.focus();
        }, 300);
    });
    ...
    btnClearVisits.addEventListener('click', () => {
        ...
        if (password === 'D20261') {
            ...
            alert('Clave incorrecta. No se borró el historial.');
        }
    });
